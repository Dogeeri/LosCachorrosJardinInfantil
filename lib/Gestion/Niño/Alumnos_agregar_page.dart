...
class _Alumnos_agregar_pageState extends State<Alumnos_agregar_page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Crear Alumnos', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold),),
                    ...
                    if (respuesta['message']!= null){
                      ...
                      //nombre
                       if(respuesta['errors']['nom_alumno']!=null){
                        errNombre = respuesta['errors']['nom_alumno'][0];
                      }else{
                        errNombre = '';
                      }

                      //
                       if(respuesta['errors']['direccion']!=null){
                        errDireccion = respuesta['errors']['direccion'][0];
                      }else{
                        errDireccion = '';
                      }
                      ...
                      if(respuesta['errors']['nom_curso']!=null){
                        errCurso = respuesta['errors']['nom_curso'][0];
                      }else{
                        errCurso = '';
                      }
                      setState(() {
